 ...
 * WEIGHTS= MUST ADD THIS ONE
 * DISTANCE = the to be determined distance of the node from the source, cost
  ...
  public static class Reduce extends MapReduceBase implements
    ...
    public void reduce(IntWritable key, Iterator<Text> values,
      ...
      while (values.hasNext()) {
        ...
        else if (u.getColor().ordinal() > color.ordinal()) {
    ...
    public int run(String[] args) throws Exception {
      ...
      while (keepGoing(iterationCount, totalIterations)) {
    ...
    private boolean keepGoing(int iterationCount, int totalIterations) {
