public class PairsRelativeOccurrenceMapper extends Mapper<LongWritable, Text, WordPair1, IntWritable> {
...
public class WordPairPartitioner extends Partitioner<WordPair1,IntWritable> {
...
public class PairsRelativeOccurrenceReducer extends Reducer<WordPair1, IntWritable, WordPair1, DoubleWritable> {
