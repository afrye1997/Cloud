...
//
//        @Override
//        public int getPartition(WordPair2 wordPair, IntWritable intWritable, int numPartitions) {
//            int partitionNum= wordPair.getWord().hashCode() % numPartitions;
//            System.out.println("ALLISON : "+ partitionNum);
...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        //job.setCombinerClass(PairsRelativeOccurrenceReducer.class);
